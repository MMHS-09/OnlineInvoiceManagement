                          ...
                          <table class="table table-striped  table-hover">
                            ...
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td><a ><?php if($s->due_balance === 0): ?>
                                   <mark style="background-color: green;color: white;" >  Paid  </mark>
                                          <?php elseif($s->invoice_type === "Quotation"): ?>
                                          <mark style="background-color: Yellow;color: black;" >  Quotation  </mark>
                                          <?php else: ?>
                                           <mark style="background-color: red;color: white;" >  <?php echo e($s->due_balance); ?> </mark>
...
<?php echo $__env->make('template.portal.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineInvoice\resources\views/page/portal/user/previousInvoiceList.blade.php ENDPATH**/ ?>