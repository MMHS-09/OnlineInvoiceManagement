      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active"  href="<?php echo e(route('profileView.index')); ?>">
...
<!-- /message --> 
                          ...
                          <div class="form-group"> <h3  align="center"> User Information</h3> <br>
                               Name: &nbsp
                              <input name="name" type="text" class="form-control"  placeholder="Name" value="<?php echo e(session('name')); ?>">
                             &nbsp Password: &nbsp
                              <input name="password" type="password" class="form-control"  placeholder="Password" value="<?php echo e(session('password')); ?>">
                              &nbsp Email: &nbsp
                              <input name="email"  type="Email" class="form-control"  placeholder="Email" value="<?php echo e(session('email')); ?>" >
                             
                               &nbsp DOB: &nbsp
                              <input name="dob" type="date" class="form-control"  value="<?php echo e(session('dob')); ?>" >
                              &nbsp Phone: &nbsp
                              <input name="phone" type="number" class="form-control" value="<?php echo e(session('phone')); ?>" >
                              <br>
                              <br>
                               &nbsp Picture: &nbsp
                              <input name="picture" type="file" class="form-control" value="C:\Xampp\htdocs\Online Invoice\onlineInvoice\public\assets\img\user_picture\<?php echo e(session('picture')); ?>"  />
                              <!-- currency -->
                              ...
                              <div class="form-group "> <h3  align="center"> Company Information</h3> <br>
                                ...
                                <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"> Logo</label>
                                  <div class="col-lg-10" align="left">
                                     <img   width="200" height="250" id="image-field" style="visibility: visible;" src="<?php echo e(asset('assets/img/company_logo')); ?>/<?php echo e(session('c_logo')); ?>" >
                                  ...
                                  <div class="col-lg-10">
                                      <input name="c_name"  type="text" class="form-control" value="<?php echo e(session('c_name')); ?>" >
                                      <br>
                                  </div>
                                  ...
                                  <div class="col-lg-10">
                                      <input name="c_address" type="text" class="form-control" value="<?php echo e(session('c_address')); ?>" >
                                      <br>
                                  </div>

                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"> Email</label>
                                  <div class="col-lg-10">
                                      <input name="c_phone" type="text" class="form-control" value="<?php echo e(session('c_phone')); ?>" >
                                      <br>
                                  </div>

                                  <label class="col-sm-2 control-label col-lg-2" for="inputSuccess"> Phone</label>
                                  <div class="col-lg-10">
                                      <input name="c_email" type="text" class="form-control"  value="<?php echo e(session('c_email')); ?>">
                                      <br>
...
<?php echo $__env->make('template.portal.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineInvoice\resources\views/page/portal/user/profile.blade.php ENDPATH**/ ?>