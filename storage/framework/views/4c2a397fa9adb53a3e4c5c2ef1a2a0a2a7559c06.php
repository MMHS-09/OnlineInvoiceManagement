          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active" ><a  href="<?php echo e(route('createinvoiceView.index')); ?>">Create New Invoice</a></li>
...
<!-- /message -->
                     <h3  align="center"> Create New Invoice/Quotation</h3> <br>
                          <div class="row mt">
                              <div class="col-sm-6 text-center">
                                    <img  src="<?php echo e(asset('assets/img/company_logo')); ?>/<?php echo e(session('c_logo')); ?>" width="200" height="250">
                                    
                                     &nbsp <label style="font-size:17px;" name="c_name"  type="text"  ><mark><?php echo e(session('c_name')); ?></mark><br><mark>Hot line </mark>: <?php echo e(session('c_phone')); ?> <br><mark>Email</mark>: <?php echo e(session('c_email')); ?> <br>
                                     <mark>Address</mark>: <?php echo e(session('c_address')); ?> 
                                      </label>
  ...
  <option value="Quotation"  >Quotation</option>
              ...
              <input name="invoice_number" type="text" class="form-controls"  placeholder="Invoice Number" value="<?php echo e($in_iv); ?>" >
                          ...
                          <div class="row mt">
                              <div class="col-sm-6 text-center">
                                <input  name="billfrom" type="text" class="form-controlss"  placeholder="Bill From" value="Bill From" >
                                  ...
                                  <input name="invoice_from" type="text" class="form-controlm"  placeholder="Who is this invoice from ? (required)" value="<?php echo e(session('c_name')); ?>" >
              <br>
              <br>
              ...
              <input name="mail_to" type="email" class="form-controlm"  placeholder="Who is this mail to? (required)"  >
                    ...
                    <?php $__currentLoopData = $productList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             ...
                             <option label='<?php echo e($s->p_price); ?>' value='<?php echo e($s->p_name); ?>' data-id="<?php echo e($s->p_description); ?>" >
...
<?php echo $__env->make('template.portal.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineInvoice\resources\views/page/portal/user/create.blade.php ENDPATH**/ ?>